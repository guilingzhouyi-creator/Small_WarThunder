...
public class MIddleInputingController : MonoBehaviour
{
    ...
    public event EventHandler OnMapShowInputProcessed;
    ...
    private void Awake()
    {
        ...
        _inputActions.TankerDriver.MapShow.performed += OnMapShowInput;
    }
    ...
    private void OnMapShowInput(InputAction.CallbackContext context)
    {
        OnMapShowInputProcessed?.Invoke(this, EventArgs.Empty);
    }
