...
//     // [SerializeField] private FCSRegistrySystem registrySystem;
//     // [SerializeField] private string tpsAimModeKey = "TPS";
//     // [SerializeField] private string aimAimModeKey = "AIM";
//     // [Header("瞄准点计算")]
...
//     // private FcsHUDPresenter _painter;
...
//     // [Header("TPS准星设置")]
//     // [SerializeField] private RectTransform tpsReticle;
//     // [SerializeField] private float sensitivity = 6f;
//     // [SerializeField] private float smoothTime = 0.04f;
//     // [SerializeField] private Vector2 maxOffsetFromCenter = new Vector2(50f, 50f);
...
//     // [Header("变焦设置")]
//     // [SerializeField] private AimConfigData currentConfig;
...
//     // [Header("Aim设置")]
//     // [SerializeField] private RectTransform aimCameraAimPosition;
...
//     //     if (tpsReticle == null)
//     //     {
//     //         tpsReticle = GetComponent<RectTransform>();
//     //     }
...
//     //     {
//     //         _targetFov = currentConfig.zoomFovLevels[0];
//     //     }
...
//     // private void Update()
//     // {
//     //     bool controlLocked = UIManager.Instance != null && UIManager.Instance.IsGameplayControlLocked;
//     //     bool currentlyPaused = UIManager.Instance != null && UIManager.Instance.IsPaused;
//     //     bool isAimMode = UIManager.Instance != null && UIManager.Instance.IsAimMode;

//     //     if (!controlLocked && isAimMode)
//     //     {
//     //         HandleZoomInput();
//     //     }
//     //     else if (!isAimMode)
...
//     //     // 如果在瞄准模式下，且有有效的 CinemachineCamera 组件，则直接切换到目标相机位置，不做平滑过渡
//     //     if (isAimMode && aimCinemachineCamera != null)
//     //     {
//     //         // 在 Cinemachine 中，Lens 是一个结构体，需要整体赋值
//     //         var lens = aimCinemachineCamera.Lens;

//     //         if (Mathf.Abs(lens.FieldOfView - _targetFov) > 0.1f)
//     //         {
...
//     //     UpdateReticleVisualState(isAimMode);

//     //     if (isAimMode)
//     //     {
//     //         UpdateAimReticleByBarrelProjection();
//     //     }

//     //     // 检测从暂停恢复的瞬间
//     //     if (_wasPausedLastFrame && !currentlyPaused)
//     //     {
//     //         // 从暂停恢复时，强制重置一次准星目标位置，避免 delta 卡住
//     //         targetScreenPos = tpsReticle.position;

//     //         Invoke(nameof(ResetCursorAfterResume), 0.05f);
//     //     }

//     //     _wasPausedLastFrame = currentlyPaused;

//     //     // 只有在非暂停状态才处理鼠标移动
//     //     if (!controlLocked && _shouldLockCursor)
//     //     {
//     //         Vector2 mouseDelta = MIddleInputingController.Instance.GetMouseDelta();

//     //         if (mouseDelta.sqrMagnitude > 0.01f)
//     //         {

//     //             float zoomModifier = mainCamera.fieldOfView / _defaultFov; // 根据当前FOV调整灵敏度

//     //             targetScreenPos += mouseDelta * sensitivity * zoomModifier;

//     //             Vector2 center = new Vector2(Screen.width * 0.5f, Screen.height * 0.5f);
//     //             targetScreenPos.x = Mathf.Clamp(targetScreenPos.x, center.x - maxOffsetFromCenter.x, center.x + maxOffsetFromCenter.x);
//     //             targetScreenPos.y = Mathf.Clamp(targetScreenPos.y, center.y - maxOffsetFromCenter.y, center.y + maxOffsetFromCenter.y);
//     //         }

//     //         tpsReticle.position = Vector2.SmoothDamp(tpsReticle.position, targetScreenPos, ref currentVelocity, smoothTime);
//     //     }

//     //     CalculateWorldAimPoint();
//     //     ApplyCursorState();
//     // }

//     // private void ResetCursorAfterResume()
//     // {
//     //     // 恢复后强制刷新一次 delta
//     //     targetScreenPos = tpsReticle.position;
//     // }
...
public class TankAImUIController : MonoBehaviour
{
    ...
    private void HandleAimZoom(bool isAimMode, NewAimConfigData config)
    {
        ...
        if (!_wasAimModeLastFrame && isAimMode)
        {
            _currentZoomIndex = 0;
